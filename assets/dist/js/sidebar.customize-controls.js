...
/******/{
   ...
   */
		...
		(function (wp, data) {
			...
			var sidebarModeDependants = ['sidebar_size', 'blog_sidebar_enabled'];
			...
			api.bind('ready', function () {
				...
				util.bindSettingToControls('sidebar_mode', sidebarModeDependants, function (value, control) {
					control.active.set('no_sidebar' !== value);
				});

				// Handle visibility of the actual blog sidebar widget area.
				util.bindSettingToSections('blog_sidebar_enabled', ['sidebar-widgets-blog'], function (value, section) {
					if (value) {
						section.activate();
						return;
					}
				...
				if (data.displayShopSidebarEnabledSetting) {
					util.bindSettingToSections('shop_sidebar_enabled', ['sidebar-widgets-shop'], function (value, section) {
						if (value) {
							section.activate();
							return;
						}
