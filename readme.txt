...
Contributors: flixos90, philliproth
Stable tag: 1.0.0
Version: 1.0.0
...
Super Awesome Theme theme for WordPress.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in 'Super Awesome Theme' in the search form and press the 'Enter' key on your keyboard.
