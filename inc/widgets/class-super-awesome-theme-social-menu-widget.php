 ...
 * @since 1.0.0
 */
class Super_Awesome_Theme_Social_Menu_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'super_awesome_theme_social_menu', __( 'Social Menu', 'super-awesome-theme' ), array(
			'classname'                   => 'widget_social_menu',
			'description'                 => __( 'Displays a social menu with icons.', 'super-awesome-theme' ),
